...
public class MainActivity extends AppCompatActivity implements GLSurfaceView.Renderer {
    ...
    // Image Detection
     private static final String SCENE_URL = "https://us-east-1.sumerian.aws/38be9ce6b64845d88e8bbc0b8b0f5cd8.scene/?arMode=true";
    ...
    private AugmentedImageDatabase getExisitingImageDatabase(Session mSession, String dbName) {

        AugmentedImageDatabase imageDatabase = new AugmentedImageDatabase(mSession) ;
     try{
         InputStream inputStream = getAssets().open(dbName);
         imageDatabase = AugmentedImageDatabase.deserialize(mSession, inputStream);
         Log.d(TAG, "Deserialized image database");
    ...
    protected void onResume() {
        ...
        if (mSession == null) {
         ...
         //   config.setAugmentedImageDatabase(getExisitingImageDatabase(mSession,  "Label.imgdb" ));
